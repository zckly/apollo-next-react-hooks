...
var useProgress = function useProgress(start, end, time) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    setProgress(start); // let rafId = null;
    // let start = null;
    // let current =
    // let step = timestamp => {
  ...
  return null; // return animate ? Math.min(progress / time, time) : 0;
};
...
//# sourceMappingURL=index.js.1aeddc2cc867aebfcd2e.hot-update.js.map
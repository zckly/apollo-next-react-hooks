...
/*!************************************************************!*\
  !*** ./node_modules/@popmotion/popcorn/dist/popcorn.es.js ***!
  \************************************************************/
/*! exports provided: createAnticipateEasing, createBackIn, createExpoIn, cubicBezier, linear, easeIn, easeOut, easeInOut, circIn, circOut, circInOut, backIn, backOut, backInOut, anticipate, reversed, mirrored, angle, applyOffset, clamp, conditional, degreesToRadians, dilate, distance, interpolate, isPoint, isPoint3D, mix, mixArray, mixColor, mixComplex, pipe, pointFromVector, progress, radiansToDegrees, smooth, smoothFrame, snap, springForce, springForceExpo, springForceLinear, steps, toDecimal, velocityPerFrame, velocityPerSecond, wrap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dilate", function() { return dilate; });
...
var calc = /*#__PURE__*/Object.freeze({
    ...
    dilate: _popmotion_popcorn__WEBPACK_IMPORTED_MODULE_1__["dilate"],
...
/* harmony import */ var popmotion_pose__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! popmotion-pose */ "./node_modules/popmotion-pose/dist/popmotion-pose.es.js");
...
var PoseElement = (function (_super) {
    ...
    function PoseElement(props) {
        ...
        _this.getRefs = function () {
            ...
            if (typeof elementType === 'string' ||
                Object(react_is__WEBPACK_IMPORTED_MODULE_2__["isForwardRef"])(elementType)) {
        ...
        _this.shouldForwardProp =
            typeof _this.props.elementType === 'string' ? _emotion_is_prop_valid__WEBPACK_IMPORTED_MODULE_4__["default"] : testAlwaysTrue;
        var poseConfig = _this.props.poseConfig;
        _this.poseConfig = typeof poseConfig === 'function'
    ...
    PoseElement.prototype.componentDidMount = function () {
        var _this = this;
        Object(hey_listen__WEBPACK_IMPORTED_MODULE_5__["invariant"])(typeof this.ref !== 'undefined', "No DOM ref found. If you're converting an existing component via posed(Component), you must ensure you're passing the hostRef prop to your underlying DOM element.");
        ...
        if (!registerChild) {
            this.initPoser(Object(popmotion_pose__WEBPACK_IMPORTED_MODULE_3__["default"])(this.ref, config));
        }
        else {
            registerChild({
                element: this.ref,
    ...
    PoseElement.prototype.render = function () {
        ...
        return (Object(react__WEBPACK_IMPORTED_MODULE_1__["createElement"])(PoseParentProvider, { value: this.childrenHandlers }, Object(react__WEBPACK_IMPORTED_MODULE_1__["createElement"])(elementType, pickAssign(this.shouldForwardProp, [
            this.getSetProps(),
            this.getRefs()
        ]))));
    };
...
var createComponentFactory = function (key) {
    var componentFactory = function (poseConfig) {
        ...
        return function (_a) {
            ...
            return !withParent || props.parentValues ? (Object(react__WEBPACK_IMPORTED_MODULE_1__["createElement"])(PoseElement, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({ poseConfig: poseConfig, elementType: key }, props))) : (Object(react__WEBPACK_IMPORTED_MODULE_1__["createElement"])(PoseParentConsumer, null, function (parentCtx) { return (Object(react__WEBPACK_IMPORTED_MODULE_1__["createElement"])(PoseElement, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({ poseConfig: poseConfig, elementType: key }, props, parentCtx))); }));
        };
    };
...
var getKey = function (child) {
    Object(hey_listen__WEBPACK_IMPORTED_MODULE_5__["invariant"])(child && child.key !== null, 'Every child of Transition must be given a unique key');
...
var handleTransition = function (_a, _b) {
    ...
    if (true) {
        Object(hey_listen__WEBPACK_IMPORTED_MODULE_5__["warning"])(!propsForChildren.onPoseComplete, "<Transition/> (or <PoseGroup/>) doesn't accept onPoseComplete prop.");
    }
...
/*!*******************************************************************************************!*\
  !*** delegated ./node_modules/react/index.js from dll-reference dll_fb3d3b7b57e2acf0c256 ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = (__webpack_require__(/*! dll-reference dll_fb3d3b7b57e2acf0c256 */ "dll-reference dll_fb3d3b7b57e2acf0c256"))("./node_modules/react/index.js");
...
var ButtonWrapper = react_pose__WEBPACK_IMPORTED_MODULE_3__["default"].div({
  idle: {
    scale: 1
  },
  hovered: {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Circle; });
/* harmony import */ var styled_jsx_style__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! styled-jsx/style */ "./node_modules/styled-jsx/style.js");
/* harmony import */ var styled_jsx_style__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(styled_jsx_style__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
...
function Circle(props) {
  ...
  var v = props.scaleV;
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: "jsx-1178505512" + " " + 'circle',
    __source: {
      fileName: _jsxFileName,
      lineNumber: 5
    },
    ...
    className: "jsx-1178505512" + " " + (props.klass || ""),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6
    },
    ...
    className: "jsx-1178505512" + " " + 'noselect',
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12
    },
    ...
    styleId: "1178505512",
    css: ".circle{background:rgba(255,255,255,1);width:50px;height:50px;border-radius:50%;text-align:center;-webkit-transition:box-shadow .3s;transition:box-shadow .3s;-webkit-transition:opacity 0.5s;transition:opacity 0.5s;}.circle:hover{box-shadow:0 5px 5px rgba(33,33,33,1);}.down-arrow{padding-top:13px;padding-left:1px;color:rgba(20,20,20,1);font-size:30px;font-family:helvetica;}.right-arrow{padding-top:11px;padding-left:4px;color:rgba(20,20,20,1);font-size:30px;font-family:helvetica;clear:both;}.left-arrow{padding-top:11px;margin-left:-4px;color:rgba(20,20,20,1);font-size:30px;font-family:helvetica;clear:both;}.up-arrow{padding:10px;color:rgba(20,20,20,1);font-size:36px;font-family:helvetica;}.noselect{-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/Users/brianmcdonough/sites/next-with-apollo/pages/portfolio/components/Circle.js */",
    __self: this
  }));
}
    (function (Component, route) {
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/portfolio/components/Circle")
...
function Contact() {
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    __self: this
  }, "Contact Brian"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", {
    className: "jsx-1431666204",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15
    ...
    __self: this
  }, "brianeebill@gmail.com"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", {
    href: "#",
    className: "jsx-1431666204",
    __source: {
      fileName: _jsxFileName,
    ...
    styleId: "1431666204",
    css: "#contact{height:500px;width:100%;color:rgba(255,255,255,1);}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/Users/brianmcdonough/sites/next-with-apollo/pages/portfolio/components/Contact.js */",
    __self: this
  }));
}
    (function (Component, route) {
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/portfolio/components/Contact")
...
function Header() {
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("nav", {
    ...
    styleId: "1911702393",
    css: "#nav{display:block;position:fixed;height:70px;z-index:7;width:100%;clear:both;background:#212121;}#logo{height:40px;width:40px;display:block;position:absolute;left:20px;padding:15px;}.links{float:right;padding-right:40px;padding-top:10px;height:35px;width:250px;}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/Users/brianmcdonough/sites/next-with-apollo/pages/portfolio/components/Header.js */",
    __self: this
  }));
}
    (function (Component, route) {
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/portfolio/components/Header")
...
function Home() {
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("section", {
    ...
    className: "jsx-2611726380" + " " + 'headline',
    __source: {
      fileName: _jsxFileName,
      lineNumber: 17
    },
    ...
    className: "jsx-2611726380" + " " + 'sub-headline',
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21
    },
    ...
    styleId: "2611726380",
    css: "#home{position:fixed;text-align:center;z-index:0;background:rgba(20,20,20,1);color:rgba(255,255,255,.9);width:100%;}.name{color:#6694BD;font-weight:200;}.text{margin:auto;position:absolute;width:100%;}.cat{width:200px;}.headline{font-size:26px;margin-top:10px;}.sub-headline{color:#3271A7;font-size:17px;margin-top:-10px;}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/Users/brianmcdonough/sites/next-with-apollo/pages/portfolio/components/Home.js */",
    __self: this
  }));
}
    (function (Component, route) {
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/portfolio/components/Home")
...
/* harmony default export */ __webpack_exports__["default"] = (HomeSpacer);
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/portfolio/components/HomeSpacer")
...
/* harmony default export */ __webpack_exports__["default"] = (Project);
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/portfolio/components/Project")
...
/* harmony default export */ __webpack_exports__["default"] = (Rocket);
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/portfolio/components/Rocket")
...
var Github = function Github() {
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    styleId: "1706931772",
    css: "#github{float:right;margin-top:10px;}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/Users/brianmcdonough/sites/next-with-apollo/pages/portfolio/components/links/Github.js */",
    __self: this
  }));
};
...
/* harmony default export */ __webpack_exports__["default"] = (Github);
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/portfolio/components/links/Github")
...
/* harmony default export */ __webpack_exports__["default"] = (LinkedIn);
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/portfolio/components/links/LinkedIn")
...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony default export */ __webpack_exports__["default"] = ([{
  ...
  'description': 'Project description two'
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/portfolio/data/projects")
...
/***/ "dll-reference dll_fb3d3b7b57e2acf0c256":
/*!*******************************************!*\
  !*** external "dll_fb3d3b7b57e2acf0c256" ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = dll_fb3d3b7b57e2acf0c256;

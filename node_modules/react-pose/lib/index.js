    ...
    function PoseElement(props) {
        ...
        _this.getRefs = function () {
            ...
            if (typeof elementType === 'string' ||
                reactIs.isForwardRef(elementType)) {
...
var createComponentFactory = function (key) {
    var componentFactory = function (poseConfig) {
        ...
        return function (_a) {
            ...
            return !withParent || props.parentValues ? (React.createElement(PoseElement, tslib_1.__assign({ poseConfig: poseConfig, elementType: key }, props))) : (React.createElement(PoseParentConsumer, null, function (parentCtx) { return (React.createElement(PoseElement, tslib_1.__assign({ poseConfig: poseConfig, elementType: key }, props, parentCtx))); }));
        };
    };
